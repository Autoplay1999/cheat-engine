...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfMonoEngineToTheCurrent = 'This will attach the debugger of '+strCheatEngine+' to the current process.';
...
begin
  ...
  begin
    ...
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:=rsThisWillAttachTheDebuggerOfMonoEngineToTheCurrent+' '+rsDoNotCloseCE
    else
    {$endif}
      mes:=rsThisWillAttachTheDebuggerOfMonoEngineToTheCurrent+' '+rsContinue;
