...
resourcestring
  ...
  rsMonoEngineSingleLingeAssembler = 'Single-line assembler';
...
begin
  ...
  //  copy
    ...
    assemblercode:=InputboxTop(rsMonoEngineSingleLingeAssembler, Format(rsTypeYourAssemblerCodeHereAddress, [inttohex(Address, 8)]), assemblercode, x='', canceled{$ifndef darwin},assemblerHistory{$endif});
