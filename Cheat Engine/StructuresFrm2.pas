...
resourcestring
  ...
  rsThisIsQuiteABigStructureHowManyBytesDoYouWantToSav = 'This is quite a big '
   ...
   rsDoYouWantMonoEngineToTryAndFillInTheMostBasicType = 'Do you want Mono '
...
begin
  ...
  begin
    ...
    autoFillIn:=messagedlg(rsDoYouWantMonoEngineToTryAndFillInTheMostBasicType, mtconfirmation, [mbyes, mbno, mbcancel], 0);
