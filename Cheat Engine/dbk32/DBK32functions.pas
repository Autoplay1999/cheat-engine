    ...
    //  usealternatedebugmethod:=false;
      ...
      try
        ...
        begin
          ...
          servicename:='KBDDRIVER';
          ultimapservicename:='ULTIMAP2';
          processeventname:='KBDProcList60';
          threadeventname:='KBDThreadList60';
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    shellexecute(0, 'open', 'https://cheeseengine.org/dbkerror.php', nil, nil, sw_show);
                  end;
                end
                else
