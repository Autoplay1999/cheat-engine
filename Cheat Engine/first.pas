...
initialization
  ...
  begin
    ...
    if r.OpenKey('\Software\'+{$ifdef altname}'Mono Engine'{$else}'Cheat Engine'{$endif},false) then
    begin
    ...
    begin
      ...
      if r.OpenKey('\Software\'+{$ifdef altname}'Mono Engine'{$else}'Cheat Engine'{$endif},true) then
      begin
        //I do have access
