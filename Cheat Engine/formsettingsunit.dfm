object formSettings: TformSettings
    ...
    object pcSetting: TPageControl
      ...
      object GeneralSettings: TTabSheet
        ...
        object EditUpdateInterval: TEdit
          ...
          Height = 24
          Hint = 
            'The number of milliseconds that Mono Engine will wait before re' +
        ...
        object cbHideAllWindows: TCheckBox
          ...
          Height = 21
          Caption = 
            'Hide some/all windows instead of trying to bring mono engine to' +
            ' front'
          Checked = True
          State = cbChecked
          TabOrder = 9
      ...
      object CodeFinder: TTabSheet
        ...
        object Label4: TLabel
          ...
          Align = alTop
          Caption = 
            'There are 2 ways Mono Engine can find the addresss of code that' +
  ...
  object OpenDialog1: TOpenDialog
    DefaultExt = 'DLL'
    Filter = 'Mono Engine Plugins (*.dll)|*.dll'
    Left = 52
    Top = 264
  end
